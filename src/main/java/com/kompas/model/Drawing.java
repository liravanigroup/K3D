...
public class Drawing {
    ...
    public Drawing(StampDTO stampDTO, LocalFile localFile) {
        ...
        this.pathToDrawingImage = new SimpleStringProperty("file:/C:/Users/Amsterdam/IdeaProjects/Kompas3D/kompas3D/src/main/resources/images/" + localFile.getName().replace(" ", "%20") + ".jpg");
